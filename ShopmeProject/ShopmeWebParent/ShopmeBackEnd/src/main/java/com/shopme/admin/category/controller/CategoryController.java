...
public class CategoryController {
	...
	// Handler method for listing categories
	...
	// Handler method to show new category form
	...
	// Handler method to save new category
	@PostMapping("/categories/save")
	public String saveCategory(@ModelAttribute Category category , 
			@RequestParam("fileImage") MultipartFile multipartFile,
			RedirectAttributes redirecAttributes) throws IOException {
		String message;
	    
	    if (category.getId() == null) {
	        message = "The new category has been created.";
	    } else {
		...
		redirecAttributes.addFlashAttribute("message", message);
		return "redirect:/categories";		
	}
	
	// Handler method to show edit category form
	...
	// Handler method to update enable / disable status
	...
	// Handler method to delete category
